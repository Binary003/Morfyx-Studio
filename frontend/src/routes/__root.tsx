...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Morfyx Studio" },
      { name: "description", content: "Custom anime figures and collectibles." },
      { name: "author", content: "Morfyx Studio" },
      { property: "og:title", content: "Morfyx Studio" },
      { property: "og:description", content: "Custom anime figures and collectibles." },
